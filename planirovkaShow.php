        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <div class="homeShowInfo">
                    ...
                    <div class="showPlanWrap">
                        <p class="homeShowPlN">План <span># 1.1</span></p>
                        ...
                        <div class="col-md-6 col-xs-6 col-sm-8">
                            ...
                            <ul class="listWithNum">
                                <li id="list1"> Холл</li>
                                <li id="list2"> Гостинная</li>
                                <li id="list3"> Кухня-студия</li>
                                <li id="list4"> Ванная комната</li>
                            </ul>
                        </div>
                        <div class="col-md-6 col-xs-6 col-sm-4">
                            <ul class="listMeters">
                                ...
                                <li id="numList3"><b class="meters">29,6</b> <span>м<span class="sqr2">2</span></span></li>
                                <li id="numList4"><b class="meters">4,2</b> <span>м<span class="sqr2">2</span></span></li>
                            </ul>
                        </div>
            ...
            <div class="col-sm-7">
                <div class="floorSwitch">
                    <span>Этаж</span>
                    <a class="floor active" id="firstFloor">1</a>
                    <a class="floor" id="secondFloor">2</a>
                </div>
                <div class="clearfix"></div>
                <div class="firstFloorMap">
                    <img src="img/map1_1.png" alt="" id="map1">
                </div>
            </div>
        </div>
    </div>
